{
  ...
  inputs = {
    ...
    fpath.url            = github:sixears/fpath/r1.3.2.29;
    monaderror-io.url    = github:sixears/monaderror-io/r1.2.5.17;
    monadio-plus.url     = github:sixears/monadio-plus/r2.5.1.33;
    parsec-plus-base.url = github:sixears/parsec-plus-base/r1.0.5.19;
  };
